...
#let _icons = (
  ...
  quote: "M 3 8.75 C 3 6.678 4.678 5 6.75 5 L 7 5 C 7.553 5 8 5.447 8 6 C 8 6.553 7.553 7 7 7 L 6.75 7 C 5.784 7 5 7.784 5 8.75 L 5 9 L 7 9 C 8.103 9 9 9.897 9 11 L 9 13 C 9 14.103 8.103 15 7 15 L 5 15 C 3.897 15 3 14.103 3 13 L 3 8.75 Z M 11 8.75 C 11 6.678 12.678 5 14.75 5 L 15 5 C 15.553 5 16 5.447 16 6 C 16 6.553 15.553 7 15 7 L 14.75 7 C 13.784 7 13 7.784 13 8.75 L 13 9 L 15 9 C 16.103 9 17 9.897 17 11 L 17 13 C 17 14.103 16.103 15 15 15 L 13 15 C 11.897 15 11 14.103 11 13 L 11 8.75 Z",
)

#let get_icon(name) = _icons.at(name, default: "")
...
#let github-alert(kind, title, accent-color, bg-color, body) = context {
  if target() == "html" {
   ...
   dir: auto)[
    ...
    let dynamic-svg = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" fill=\"" + accent-color.to-hex() + "\"><path d=\"" + get_icon(kind) + "\"/></svg>"
